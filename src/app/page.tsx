        ...
        <div className="relative">
          ...
          <div className="bg-earth-50/80 dark:bg-earth-800/80 backdrop-blur-lg rounded-3xl p-12 max-w-3xl mx-auto shadow-2xl shadow-earth-900/5 dark:shadow-earth-900/20 border border-earth-200/50 dark:border-earth-700/50">
            <div className="text-center mb-8">
              ...
              {user ? (
                <p className="text-earth-600 dark:text-earth-400">Select or upload a document to analyze</p>
              ) : (
                <p className="text-earth-600 dark:text-earth-400">
                  {isDemo ? "Select an example document to analyze" : "Sign in to analyze your documents or try our demo"}
                </p>
              )}
            </div>
            ...
            <div className="space-y-6">
              {/* Sign in / Demo prompt when not authenticated and not in demo mode */}
              {!user && !isDemo ? (
                <div className="text-center space-y-4">
                  <div className="flex gap-4 justify-center">
                    ...
                    <button
                      ...
                      className="px-6 py-3 border border-earth-300 text-earth-700 dark:text-earth-300 rounded-lg hover:bg-earth-50 dark:hover:bg-earth-800 transition-colors"
                    >
                      Try Demo
                    </button>
                  </div>
